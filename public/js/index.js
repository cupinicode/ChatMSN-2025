...
// const formChat = document.querySelector('#formChat'); // Otra forma de obtener el formulario por su id
const inoutUserName = document.getElementById('inputUserName'); // Obtenemos el input por su id
...
formChat.addEventListener('submit', (event) => { // Agregamos un evento al formulario
    ...
    const userName = inoutUserName.value; // Obtenemos el valor del input del formulario
